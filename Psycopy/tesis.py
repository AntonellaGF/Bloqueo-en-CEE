...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath='C:\\Tesis 2021\\Bloqueo-en-CEE\\Psycopy\\tesis.py',
...
introduccion2 = visual.TextStim(win=win, name='introduccion2',
    text='Tu participación es voluntaria: \npodés rehusarte a participar o interrumpir tu participación en cualquier momento sin tener que expresar tus razones.\n\nEn el experimento vas a tener que apretar las flechas: la fecha izquierda es "opción incorrecta", la fecla derecha es "opción correcta"\n\nAPRETA LA BARRA ESPACIADORA PARA CONTINUAR ',
    font='Open Sans',
...
text = visual.TextStim(win=win, name='text',
    text='¿Conocías agunas de las letras que se mostraron en el experimento? (1=si // 2=no)\n\nAl finalizar apreta la barra espaciadora ',
    font='Open Sans',
    pos=(0, 0), height=0.05, wrapWidth=None, ori=0.0, 
    color='white', colorSpace='rgb', opacity=None, 
    languageStyle='LTR',
    ...
    while continueRoutine and routineTimer.getTime() > 0:
        ...
        if flechas.status == STARTED and not waitOnFlip:
            ...
            if len(_flechas_allKeys):
                ...
                # was this correct?
                if (flechas.keys == str(correcta)) or (flechas.keys == correcta):
                    flechas.corr = 1
                else:
                    flechas.corr = 0
                # a response ends the routine
...
while continueRoutine:
    ...
    if key_resp_4.status == STARTED and not waitOnFlip:
        theseKeys = key_resp_4.getKeys(keyList=['enter'], waitRelease=False)
...
_key_resp_5_allKeys = []
# keep track of which components have finished
pregunta2Components = [text, key_resp_5]
